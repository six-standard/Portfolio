              ...
              content: (
                <List
                  contents={[
                    ...
                    [
                      "웹훅 기반 배치 처리 방식을 적용하여 크롤링 성능 개선 (1시간 50분~ → ~15분)",
                    ],
                    ...
                    [
                      "불편한 ![기존 스니펫 뷰어](https://snippet-builder.channel.io/)를 대신하여 약 15분만에 바이브 코딩을 통해 ![커스텀 스니펫 뷰어](https://yook-gijun.github.io/)를 제작 및 배포하고 팀에 공유",
                    ],
                  ]}
                />
              ),
